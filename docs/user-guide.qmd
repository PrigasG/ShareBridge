---
title: "User Guide"
description: "How end users run a Shiny ShareBridge app — no R installation required"
---

This guide is for the **end users** who receive a Shiny ShareBridge-deployed app. You can share this page directly with your team.
...
On the very first launch, Shiny ShareBridge will ask:
...
You opened `LaunchApp.hta` from the wrong location — likely the Shiny ShareBridge framework folder rather than the deployment folder. Make sure you are opening it from inside the folder your team shared with you.
...
Shiny ShareBridge will automatically fall back to a random port. The app should still open — the URL in the browser will be different from usual.
