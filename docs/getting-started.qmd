...
description: "Install Shiny ShareBridge and build your first deployment in under 10 minutes"
---
...
<ol class="step-list">
  <li>
    <div>
      ...
      <code>app.R</code> (or <code>ui.R</code> + <code>server.R</code>). Shiny ShareBridge validates the
  ...
  <li>
    <div>
      ...
      Shiny ShareBridge scans your app code and lists all packages it found. Review the dependency notes
      and preflight checks, then add any extras the scanner might miss (dynamic loading, etc.) in the
      <em>Additional packages</em> box.
    </div>
  </li>
  <li>
    <div>
...
See [Cloud Publishing](cloud-publishing.html) for the ShareBridge-specific hosted publishing workflows.
...
- [Cloud Publishing](cloud-publishing.html) — publish the same app source to Posit Connect Cloud or Hugging Face Spaces
